...
Source0  : https://files.pythonhosted.org/packages/b5/7e/ddfbd640ac9a82e60718558a3de7d5988a7d4648385cf00318f60a8b073a/distro-1.7.0.tar.gz
...
%prep
%setup -q -n distro-1.7.0
cd %{_builddir}/distro-1.7.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650344290
...
cp %{_builddir}/distro-1.7.0/LICENSE %{buildroot}/usr/share/package-licenses/distro/c700a8b9312d24bdc57570f7d6a131cf63d89016
